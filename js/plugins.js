        ...
        1: [function(t, e) {
            ...
            n.prototype = {
                ...
                removeHandler: function(t) {
                    var e = this.handlers;
                    o(e, function(n, i) {
                        return n.equals(t) ? (n.destroy(), !e.splice(i, 1)) : void 0
                    })
                },
                matches: function() {
        ...
        2: [function(t, e) {
            ...
            n.prototype = {
                ...
                register: function(t, e, n) {
                    ...
                    return o[t] || (o[t] = new i(t, a)), s(e) && (e = {
                        match: e
                    }), u(e) || (e = [e]), r(e, function(e) {
                        s(e) && (e = {
                            match: e
                        }), o[t].addHandler(e)
                    }), this
...
function findShapeIndex(target, endShape, vars) {
    ...
    var _doc = document,
        ...
        startDot, endDot, incrementButton, decrementButton, _setup = function() {
            ...
            TweenLite.set([incrementButton, decrementButton], {
                display: "inline-block",
                padding: "0 15px",
                color: "#ccc",
                height: "50px",
            ...
            TweenLite.set(decrementButton, {
                borderRight: "1px solid #999"
            });
            TweenLite.set(incrementButton, {
        ...
        shapeTween, dotTween, startBezier, endBezier, dotProxy = {
            x: 0,
            y: 0
        },
        ...
        _startTween = function() {
            ...
            shapeTween = TweenLite.to(target, vars.duration || 3, {
                delay: 0.5,
                morphSVG: {
                    shape: endShape,
                    shapeIndex: index
        ...
        _refresh = function() {
            ...
            _startTween();
            TweenLite.fromTo(label.parentNode, 0.4, {
                backgroundColor: "#777"
            }, {
                backgroundColor: "black",
    ...
    TweenLite.killTweensOf([target, endShape], false, {
        morphSVG: true
    });
    _startTween();
    label.innerHTML = "shapeIndex: " + index + (index === autoIndex ? " (auto)" : "");
...
! function(e, t, s) {
    function r(e, s) {
        var r = t(e);
        r.data(n, this), this._$element = r, this.shares = [], this._init(s), this._render()
    }
    var a = "JSSocials",
        n = a,
        i = function(e, s) {
    ...
    r.prototype = {
        ...
        _defineOptionsByScreen: function() {
            this._screenWidth = t(e).width(), this._showLabel = i(this.showLabel, this, this._screenWidth), this._showCount = i(this.showCount, this, this._screenWidth)
        },
        ...
        _createShare: function(e) {
            var s = t("<div>"),
                r = this._createShareLink(e).appendTo(s);
            if (this._showCount) {
                var a = "inside" === this._showCount,
                    n = a ? r : t("<div>").addClass(this.shareCountBoxClass).appendTo(s);
                n.addClass(a ? this.shareLinkCountClass : this.shareCountBoxClass), this._renderShareCount(e, n)
            }
            return s
        },
        _createShareLink: function(e) {
            var s = this._getShareStrategy(e),
                r = s.call(e, {
                    shareUrl: this._getShareUrl(e)
                });
            return r.addClass(this.shareLinkClass).append(this._createShareLogo(e)), this._showLabel && r.append(this._createShareLabel(e)), t.each(this.on || {}, function(s, a) {
                t.isFunction(a) && r.on(s, t.proxy(a, e))
            }), r
        },
        _getShareStrategy: function(e) {
            var t = f[e.shareIn || this.shareIn];
            if (!t) throw Error("Share strategy '" + this.shareIn + "' not found");
            return t
        },
        _getShareUrl: function(e) {
            var t = i(e.shareUrl, e);
            return this._formatShareUrl(t, e)
        },
        _createShareLogo: function(e) {
            var s = e.logo,
                r = o.test(s) ? t("<img>").attr("src", e.logo) : t("<i>").addClass(s);
        ...
        _formatNumber: function(e) {
            return t.each(h, function(t, s) {
                return e >= s ? (e = parseFloat((e / s).toFixed(2)) + t, !1) : void 0
            }), e
        },
        _formatShareUrl: function(t, s) {
            return t.replace(l, function(t, r, a) {
                var n = s[a] || "";
        ...
        destroy: function() {
            this._clear(), this._detachWindowResizeCallback(), this._$element.removeClass(this.elementClass).removeData(n)
        },
        option: function(e, t) {
        ...
        return this.each(function() {
            ...
            if (h)
                if ("string" == typeof e) {
                    if (a = h[e].apply(h, i), a !== s && a !== h) return o = a, !1
                } else h._detachWindowResizeCallback(), h._init(e), h._render();
            else new r(l, e)
        }), o
    };
    var c = function(e) {
            var s;
            t.isPlainObject(e) ? s = r.prototype : (s = u[e], e = arguments[1] || {}), t.extend(s, e)
        },
        f = {
            popup: function(s) {
...
(function(c) {
    ...
    var a = window.Visibility = {
        onVisible: function(e) {
            if (!a.isSupported() || !a.hidden()) {
                e();
                return a.isSupported()
            }
            var d = a.change(function(g, f) {
                if (!a.hidden()) {
                    a.unbind(d);
                    e()
                }
        ...
        afterPrerendering: function(e) {
            if (!a.isSupported() || "prerender" != a.state()) {
                e();
                return a.isSupported()
            }
            var d = a.change(function(g, f) {
        ...
        hidden: function() {
            return a._prop("hidden", false)
        },
        state: function() {
            return a._prop("visibilityState", "visible")
        },
        ...
        _prefix: function() {
            ...
            if (b(a._doc.visibilityState)) {
                return a._cached = ""
            }
            if (b(a._doc.webkitVisibilityState)) {
                return a._cached = "webkit"
            }
        },
        _name: function(d) {
            var e = a._prefix();
            if ("" == e) {
                ...
                return e + d.substr(0, 1).toUpperCase() + d.substr(1)
            }
        },
        _prop: function(d, e) {
            if (!a.isSupported()) {
        ...
        _listen: function() {
            ...
            var d = a._prefix() + "visibilitychange";
            var e = function() {
                a._change.apply(Visibility, arguments)
            };
            if (a._doc.addEventListener) {
                a._doc.addEventListener(d, e, false)
            } else {
...
});; /*!ScrollMagic v2.0.6 | (c) 2018 Jan Paepke (@janpaepke) | license & info: http://scrollmagic.io*/ /*!ScrollMagic v2.0.6 | (c) 2018 Jan Paepke (@janpaepke) | license & info: http://scrollmagic.io*/
! function(e, i) {
...
! function(t) {
    ...
    var s = function() {
        function t(t, s) {
            var e = void 0 !== s ? s : {};
            this.version = "3.6.5", this.userAgent = window.navigator.userAgent || "no `userAgent` provided by the browser", this.props = {
...
! function() {
    ! function(i, e) {
        ...
        function i(i, n, r, o) {
            var a = "content" === r && o.indexOf("viewport-units-buggyfill") > -1;
            if (a) {
                var f = o.replace(t, "");
                f.split(";").forEach(function(t) {
                    var r = t.split(":");
                    if (2 === r.length) {
                        var o = r[0].trim();
                        if ("viewport-units-buggyfill" !== o) {
                            var a = r[1].trim();
                            if (i.push([n, o, a]), e.test(a)) {
                                var f = a.replace(e, "-webkit-calc(");
                                i.push([n, o, f])
                            }
                        }
                    }
    ...
    ! function(e, t) {
        ...
        function n(n) {
            if (!b) {
                if (n === !0 && (n = {
                        force: !0
                    }), w = n || {}, w.isMobileSafari = S, w.isBadStockAndroid = A, !w.ignoreVmax || w.force || C || (R = !1), C || !w.force && !S && !R && !A && !M && (!w.hacks || !w.hacks.required(w))) return window.console && C && console.info("viewport-units-buggyfill requires a proper CSSOM and basic viewport unit support, which are not available in IE8 and below"), {
                    init: function() {}
                };
                window.dispatchEvent(new I("viewport-units-buggyfill-init")), w.hacks && w.hacks.initialize(w), b = !0, y = document.createElement("style"), y.id = "patched-viewport", document[w.appendToBody ? "body" : "head"].appendChild(y), f(function() {
                    var n = e(r, w.refreshDebounceWait || 100);
                    window.addEventListener("orientationchange", n, !0), window.addEventListener("pageshow", n, !0), (w.force || R || t()) && (window.addEventListener("resize", n, !0), w._listeningToResize = !0), w.hacks && w.hacks.initializeEvents(w, r, n), r()
                })
            }
        }

        function i() {
            y.textContent = u(), y.parentNode.appendChild(y), window.dispatchEvent(new I("viewport-units-buggyfill-style"))
        }
        ...
        function a() {
            return g = [], k.call(document.styleSheets, function(e) {
                var t = o(e);
                t && "patched-viewport" !== e.ownerNode.id && "ignore" !== e.ownerNode.getAttribute("data-viewport-units-buggyfill") && (e.media && e.media.mediaText && window.matchMedia && !window.matchMedia(e.media.mediaText).matches || k.call(t, s))
            }), g
        }
        ...
        function s(e) {
            if (7 === e.type) {
                ...
                return E.lastIndex = 0, void(E.test(t) && !T.test(t) && (g.push([e, null, t]), w.hacks && w.hacks.findDeclarations(g, e, null, t)))
            }
            if (!e.style) {
                if (!e.cssRules) return;
            ...
            k.call(e.style, function(t) {
                ...
                e.style.getPropertyPriority(t) && (n += " !important"), E.lastIndex = 0, E.test(n) && (g.push([e, t, n]), w.hacks && w.hacks.findDeclarations(g, e, t, n))
            })
        }
        ...
        function c(e, t, n) {
            var i, r = [];
            i = n.replace(E, d), w.hacks && (i = w.hacks.overwriteDeclaration(e, t, i)), t && (r.push(e.selectorText), i = t + ": " + i + ";");
        ...
        function f(e) {
            ...
            k.call(document.styleSheets, function(e) {
                e.href && h(e.href) !== h(location.href) && "ignore" !== e.ownerNode.getAttribute("data-viewport-units-buggyfill") && (t++, p(e.ownerNode, n))
            }), t || e()
        }
        ...
        var w, m, g, y, b = !1,
            ...
            E = /([+-]?[0-9.]+)(vh|vw|vmin|vmax)/g,
            T = /(https?:)?\/\//,
            k = [].forEach,
            R = /MSIE [0-9]\./i.test(x),
            C = /MSIE [0-8]\./i.test(x),
            M = x.indexOf("Opera Mini") > -1,
            S = /(iPhone|iPod|iPad).+AppleWebKit/i.test(x) && function() {
                var e = x.match(/OS (\d+)/);
