...
if (isIE11) {
    document.documentElement.classList.add('is-ie11'); // html
}
...
! function(e, t, n) {
    ...
    function o() {
        ...
        for (var l in _)
            if (_.hasOwnProperty(l)) {
                ...
                for (o = r(t.fn, "function") ? t.fn() : t.fn, s = 0; s < e.length; s++) i = e[s], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = o : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = o), C.push((o ? "" : "no-") + a.join("-"))
            }
    }
    ...
    function h(e, t, o, s) {
        ...
        for (p = e.length, d = 0; p > d; d++)
            if (m = e[d], h = A.style[m], f(m, "-") && (m = a(m)), A.style[m] !== n) {
    ...
    function g(e, t, n, o, s) {
        ...
        return r(t, "string") || r(t, "undefined") ? h(a, t, o, s) : (a = (e + " " + k.join(i + " ") + i).split(" "), d(a, t, n))
    }
    ...
    var C = [],
        ...
        Modernizr = function() {};
    Modernizr.prototype = b, Modernizr = new Modernizr, Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), Modernizr.addTest("mutationobserver", !!e.MutationObserver || !!e.WebKitMutationObserver);
    var S = t.documentElement,
        w = "svg" === S.nodeName.toLowerCase(),
        x = b._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
    b._prefixes = x, Modernizr.addTest("csspointerevents", function() {
        var e = i("a").style;
    ...
    var O = "Moz O ms Webkit",
        N = b._config.usePrefixes ? O.split(" ") : [];
    b._cssomPrefixes = N;
    var R = function(t) {
        var r, o = x.length,
            s = e.CSSRule;
    ...
    b.atRule = R;
    var k = b._config.usePrefixes ? O.toLowerCase().split(" ") : [];
    b._domPrefixes = k;
    var z = {
        elem: i("modernizr")
    };
    ...
    var P = b.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? R(e) : (-1 != e.indexOf("-") && (e = a(e)), t ? g(e, t, n) : g(e, "pfx"))
    };
    Modernizr.addTest("forcetouch", function() {
            return T(P("mouseforcewillbegin", e, !1), e) ? MouseEvent.WEBKIT_FORCE_AT_MOUSE_DOWN && MouseEvent.WEBKIT_FORCE_AT_FORCE_MOUSE_DOWN : !1
        }), b.testAllProps = y, Modernizr.addTest("cssanimations", y("animationName", "a", !0)), Modernizr.addTest("flexbox", y("flexBasis", "1px", !0)), Modernizr.addTest("csstransitions", y("transition", "all", !0)),
        function() {
        ...
        }(), o(), s(C), delete b.addTest, delete b.addAsyncTest;
